...
import { useLikeTweetMutation } from '../stores/authApiSlice'
...
function TweetComponent({ tweet }: TweetProps) {
  ...
  return (
    <div className='border-b border-zinc-800 cursor-pointer p-4 pb-0 border-l border-r flex items-start gap-2'>
      <img
