    ...
    <div className='border-b border-zinc-800 pb-4 border-l border-r'>
      <div className='flex items-start p-4'>
        ...
        <form className='flex-1 p-2' onSubmit={submitHandle}>
          <textarea
            ref={textAreaRef}
            className={`text-white placeholder-zinc-500 text-xl w-full bg-transparent border-none focus:outline-none resize-none p-1 mb-4`}
          ...
          <div className='w-full flex'>
            <button
              type='button'
              className='text-blue hover:bg-blue/10 rounded-full p-2 active:bg-blue/20'
            >
