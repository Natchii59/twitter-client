...
function Home() {
  ...
  return (
    <HomeLayout>
      {/* Header */}
      <div className='flex justify-between items-center border-b px-4 py-3 sticky top-0 border-l border-r border-zinc-700'>
        {/* Title */}
      ...
      {/* Post Tweet */}
      <div className='border-b border-zinc-700 pb-4 border-l border-r'>
        <div className='flex flex-shrink-0 p-4 pb-0'>
          ...
          <div className='w-full p-2'>
            <textarea
              className='text-white placeholder-zinc-500 text-xl w-full h-10 bg-transparent border-0 focus:outline-none resize-none'
        ...
        <div className='w-full flex items-top p-2 text-white pl-14'>
          <button className='text-blue hover:bg-blue/10 rounded-full p-2'>
